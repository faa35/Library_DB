...
def init_db():
    ...
    # Schema of the tables are below,
    # Item Table
    cursor.execute('''
    ...
    # Creating Triggers
    # Trigger 1: setting Availability to 0 when a copy is borrowed (INSERT into Borrows)
    cursor.execute('''
    ...
    # Trigger 2: Availability to 1 when a copy is returned (UPDATE on Borrows)
    cursor.execute('''
    ...
    # Trigger 3: we will recalculate TotalFines after a new borrow (INSERT into Borrows)
    cursor.execute('''
    ...
    # populating the tables with generated data
    # Items (10 tuples)
    ...
    # Users (10 tuples) - so TotalFines set to 0 since it will be calculated by the trigger
